...
- Play the same signal to two output devices at the same time:
  monitor/headphones and injection/virtual cable.
...
class AudioDevice:
    """A simplified view of a sounddevice output device."""
...
class AudioHandler:
    ...
    def __init__(
        ...
        *,
        ...
        self._playback_id = 0
        self._active: Optional[_DualPlayback] = None
    ...
    if args.list_devices or not args.file:
        ...
        if not args.file:
            ...
            print(
                ...
                "python audio_handler.py --file clip.wav --monitor 3 --injection 8"
            )
        return 0
